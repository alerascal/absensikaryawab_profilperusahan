...
@section('title', 'Tambah Shift - AttendPro')
...
<div class="main-content" style="padding: 24px; font-family: 'Inter', sans-serif; background: #f4f7fc;">
    <div class="form-panel" style="background: #fff; border-radius: 1rem; padding: 24px; box-shadow: 0 10px 20px rgba(0,0,0,0.1);">
        ...
        <!-- Header -->
        <h1 style="font-size: 24px; font-weight: 600; color: #1f2937; margin-bottom: 8px;">Tambah Shift</h1>
        <p style="color: #6b7280; margin-bottom: 24px;">Buat shift baru untuk jadwal karyawan</p>
        ...
        <!-- Form -->
        <form action="{{ route('admin.shifts.store') }}" method="POST" style="display: flex; flex-direction: column; gap: 16px;">
            @csrf
