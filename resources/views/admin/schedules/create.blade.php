...
<div class="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8 font-sans">
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg p-6 sm:p-8">
        ...
        <div class="mb-6 flex items-center justify-between">
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Tambah Jadwal</h1>
        ...
        <form action="{{ route('admin.schedules.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <select name="is_fulltime" id="is_fulltime"
                    ...
                    <option value="0" {{ old('is_fulltime') == 0 ? 'selected' : '' }}>
                        Berdasarkan Shift
                    </option>
                </select>
            </div>
            ...
            <!-- Shift -->
            <div id="shift_group" class="hidden">
            ...
            <!-- Users -->
            <div id="users_group" class="hidden">
